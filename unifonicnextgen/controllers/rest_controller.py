...
from unifonicnextgen.models.get_messages_details_response import (
    GetMessagesDetailsResponse,
)
from unifonicnextgen.models.get_scheduled_message_response import (
    GetScheduledMessageResponse,
)
from unifonicnextgen.models.send_response import SendResponse
from unifonicnextgen.models.send_scheduledmessages_response import (
    SendScheduledmessagesResponse,
)
from unifonicnextgen.models.stop_scheduled_messages_response import (
...
class RestController(BaseController):
    ...
    def delete_stop_scheduled_messages(
        self, app_sid, message_id=None, response_format=None, base_encode=None
    ):
        ...
        return APIHelper.json_deserialize(
            _context.response.raw_body, StopScheduledMessagesResponse.from_dictionary
        )

    def create_send_scheduled_messages(
        self,
        app_sid,
        sender_id,
        recipient,
        ...
        _query_parameters = {
            ...
            "Recipient": recipient,
            "Body": body,
            "TimeScheduled": APIHelper.when_defined(
                APIHelper.HttpDateTime, time_scheduled
            ),
        ...
        if _context.response.status_code == 401:
            ...
            raise APIException(
                "TimeScheduled parameter must indicate time in the future", _context
            )
        ...
        # Return appropriate type
        return APIHelper.json_deserialize(
            _context.response.raw_body, SendScheduledmessagesResponse.from_dictionary
        )

    def create_get_message_details(
        self,
        app_sid,
        message_id=None,
        sender_id=None,
        ...
        # Return appropriate type
        return APIHelper.json_deserialize(
            _context.response.raw_body, GetMessagesDetailsResponse.from_dictionary
        )

    def get_scheduled_message_details(self, app_sid):
        ...
        _query_builder = Configuration.get_base_uri(Configuration.Server.BASE_URL)
        _query_builder += _url_path
        _query_parameters = {"AppSid": app_sid}
        _query_builder = APIHelper.append_url_with_query_parameters(
            _query_builder, _query_parameters, Configuration.array_serialization
        )
        _query_url = APIHelper.clean_url(_query_builder)
        ...
        # Return appropriate type
        return APIHelper.json_deserialize(
            _context.response.raw_body, GetScheduledMessageResponse.from_dictionary
        )
    ...
    def create_send_message(
        ...
        # Validate required parameters
        self.validate_parameters(
            app_sid=app_sid, sender_id=sender_id, body=body, recipient=recipient
        )
        ...
        # Return appropriate type
        return APIHelper.json_deserialize(
            _context.response.raw_body, SendResponse.from_dictionary
        )
