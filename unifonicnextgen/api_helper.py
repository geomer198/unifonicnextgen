    ...
    def serialize_array(key, array, formatting="indexed"):
        ...
        if isinstance(array[0], serializable_types):
            if formatting == "unindexed":
                tuples += [("{}[]".format(key), element) for element in array]
            elif formatting == "indexed":
                tuples += [
                    ("{}[{}]".format(key, index), element)
    ...
    def append_url_with_template_parameters(url, parameters, encode=True):
        ...
        for key in parameters:
            ...
            if element is None:
                ...
                replace_value = "/".join(
                    (quote(str(x), safe="") if encode else str(x)) for x in element
                )
            else:
        ...
        for key, value in parameters.items():
            ...
            if value is not None:
                if isinstance(value, list):
                    ...
                    url += "{}{}={}".format(seperator, key, quote(str(value), safe=""))
